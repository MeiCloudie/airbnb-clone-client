...
import { GENDER_OPTIONS, useUserTableFilters } from '@/components/section/admin/user/user-tables/use-user-table-filters'
...
export default function UserTable({ data, totalData }: { data: User[]; totalData: number }) {
  const { genderFilter, setGenderFilter, isAnyFilterActive, resetFilters, searchQuery, setPage, setSearchQuery } =
    useUserTableFilters()
